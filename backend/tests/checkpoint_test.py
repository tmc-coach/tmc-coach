...
from database_functions.checkpoint_functions import set_checkpoints_function, get_checkpoints_function
import datetime
...
class CheckpointsTestCase(TestCase):
    ...
    def test_set_checkpoints_function_does_not_set_any_checkpoints_if_the_deadline_is_too_close(self):
        user_id = os.getenv("TMCUSERID")
        course_id = 3
        created_at = datetime.datetime(2023, 3, 6)
