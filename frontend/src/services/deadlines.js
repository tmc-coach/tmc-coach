...
const set_deadline = async data => {
  ...
  //const options = { year: 'numeric', month: 'numeric', day: 'numeric', timeZone: 'Europe/Helsinki' }
  //console.log(new Intl.DateTimeFormat('en-GB', { dateStyle: 'short', timeZone: 'Europe/Helsinki' }).format(data.date))
  //console.log(new Intl.DateTimeFormat('en-GB', options).format(data.date))
