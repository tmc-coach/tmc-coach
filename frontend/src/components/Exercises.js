      ...
      <>
        {exercises[0].maximum_exercises > -1 ? (
          <>
            ...
            Awarded points: {exercises[0].awarded_points} / {exercises[0].maximum_exercises} ({exercises[0].completed_percentage}%)
            </div>
            ...
            <Deadlines course_id={course_id} exercises={exercises}/>
          </>
        ) : (
