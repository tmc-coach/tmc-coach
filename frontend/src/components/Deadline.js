  ...
  return (
    <div>
      {LoadingSpinner ? (
        ...
        <div className="order-last my-4 mx-auto h-auto max-w-2xl rounded-md border-solid border-4 border-black-800">
          <p key={deadlines.id} className="flex justify-center px-5 m-5 text-2xl">You have planned to complete this course by {formatDate(deadlines.date.split(' ')[0])}</p>
