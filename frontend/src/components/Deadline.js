    ...
    <div>
      {LoadingSpinner ? (
        ...
        <div className="my-4 rounded-md border-solid border-4 border-black-800">
          <p key={deadlines.id} className="flex justify-center px-5 m-5 text-2xl">You have planned to complete {deadlines.target_points} points by {deadlines.date.split(' ')[0]}</p>
